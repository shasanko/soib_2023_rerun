...
# single year models produce notably higher estimates than full-year models
  ...
  species_to_process <- c("Black-necked Stork")
    ...
    # start as many threads as we have (remaining) capacity for
      ...
      launch_species <- species_to_process[1]
        ...
        checklistinfo_latest_bnst <- checklistinfo
        
        # Checkpoint
        
        save(checklistinfo_latest, file = "01_analyses_full/checklistinfo_latest.RData")
        save(checklistinfo_latest_bnst, file = "01_analyses_full/checklistinfo_latest_bnst.RData")
          ...
          expanded_latest <- expanded
          expanded_latest_bnst <- expanded
          
          # Checkpoint
          
          save(expanded_latest, file = "01_analyses_full/expanded_latest.RData")
          save(expanded_latest_bnst, file = "01_analyses_full/expanded_latest_bnst.RData")
